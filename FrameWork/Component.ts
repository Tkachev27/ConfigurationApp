...
export class Component {
    ...
    patch(
        ...
        if (this.dynamic) {
            //console.log('входные данные', nextVnode, $element, prevVNode)
            ...
            if (
                ...
                //console.log(
                //     'id состояний не равны, перерисовывается компонент',
                //     prevVNode,
                //     nextVnode
                // )
                ...
                //console.log('id состояний равны', prevVNode, nextVnode)
                ...
                if (
                    ...
                    // console.log(
                    //     'дети нового компонента являются текстом',
                    //     prevVNode.children,
                    //     nextVnode.children
                    //)
                    if (prevVNode.children !== nextVnode.children) {
                        // console.log(
                        //     'текст у компонентов не равен или раньше был не текст'
                        // )
                        $element.textContent = nextVnode.children.toString()
                    }
                } else {
                    //console.log('дети нового компонента не текст')
                    ...
                    if (
                        ...
                        //console.log('раньше был текст а стал массив')
                        $element.textContent = ''
                        ...
                        //console.log('дочерний элемент массив ')
                        ...
                        for (let i = 0; i < prevVNode.children.length; i++) {
                            ...
                            if (idx == -1) {
                                //console.log(
                                //     'индекс элемента старой ноды которого нет в новой, который будет удален',
                                //     $element
                                // )
                        ...
                        for (let i = 0; i < nextVnode.children.length; i++) {
                            ...
                            //console.log(indx, duplicate, 'цикл по детям', i)
                            ...
                            if (indx != -1 && indx == i && !duplicate) {
                                ...
                                //console.log('Позиции элементов совпадают')
                                ...
                                //console.log(
                                //     'Позиции элементов не совпадают идет перестановка'
                                // )
                                ...
                                //переставляем элемент и обновляем
                                //console.log('новый или дубликат')
                                if (
                                    nextVnode.children[
                                        i
            ...
            if ($element.parentNode == this.parent) {
                //console.log('сохраняем итоговые варианты', nextVnode, $element)
